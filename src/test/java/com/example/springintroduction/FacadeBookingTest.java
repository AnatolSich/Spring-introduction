...
public class FacadeBookingTest {
    ...
    public void createAndUpdateUserTest() {
        bookingFacade.createUser(new UserImpl(3, "Yurii", "none"));
        bookingFacade.updateUser(new UserImpl(3, "Yurii", "Yurii@epam.com"));
        Assert.assertEquals(3, bookingFacade.getUserByEmail("Yurii@epam.com").getId());
    }
    ...
    public void bookTicketAndCancel() {
        bookingFacade.createEvent(new EventImpl(100, "JUG#Kharkiv", Date.from(Instant.now()), 200));
        bookingFacade.createUser(new UserImpl(1111, "Yurii", "Yurii@epam.com"));
